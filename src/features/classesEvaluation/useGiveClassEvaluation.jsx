...
const useGiveClassEvaluation = ({
  ...
  const giveEvaluationSchema = yup.object({
  ...
  const {
    ...
    resolver: yupResolver(giveEvaluationSchema),
  });
...
useGiveClassEvaluation.propTypes = {};

export default useGiveClassEvaluation;
